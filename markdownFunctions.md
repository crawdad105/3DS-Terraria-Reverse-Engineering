...
| `0x00109610` | `int32_t StateManager::AddState(GameStateManager* gsm, String* str, void* obj)` |  |
...
| `0x0010fd28` | `SpriteInfo* SpriteBatch::Begin(SpriteBatch* sb, bool zoomEnable, int32_t arg3, SpriteInfo* arg4)` |  |
...
| `0x0010fdbc` | `void* CameraZoomer::CameraZoomer(void* arg1)` | Seems to match somewhat to the mobile function. |
...
| `0x00115228` | `void State::State(int32_t* arg1)` |  |
...
| `0x0011ee54` | `int32_t Sprite::reload(Sprite* sprite, int64_t arg2 @ q0)` |  |
...
| `0x00122ac4` | `int32_t GraphicsDevice::QueryBuffer(GraphicsDevice* arg1, int32_t* arg2, int32_t arg3, uint8_t* __offset(_GraphicsDevice, 0x5c) arg4)` |  |
...
| `0x0012cdd8` | `void* StateManager::~StateManager(GameManager_VTable** arg1)` |  |
...
| `0x0014df8c` | `void** Stopwatch::Stopwatch(void** arg1)` |  |
...
| `0x0017f418` | `int32_t Background::Draw(void* arg1, int32_t arg2 @ r4)` | Not an exact match to the mobile version but the name is close enough. |
...
| `0x001c8da0` | `BaseDrawable* SpriteText::SpriteText(BaseDrawable* arg1, int32_t arg2, int32_t* arg3)` |  |
...
| `0x001d8b18` | `int32_t* ExtractState::ExtractState(int32_t* arg1)` |  |
...
| `0x001e4058` | `uint32_t BaseDrawable::SetTexture2(BaseDrawable* drawable, Texture* texture)` |  |
| `0x001e41cc` | `int32_t BaseDrawable::SetTexture(void* arg1, int32_t* arg2, int32_t arg3 @ r4, int32_t arg4 @ r5)` |  |
...
| `0x001e7ec8` | `float CameraZoomer::ApplyZoomToScreenPos(Vector2* pos, void* cameraZoomer, Vector2* scale)` |  |
...
| `0x001f6f14` | `int32_t StateManager::Draw(void* arg1)` |  |
...
| `0x00204fa4` | `void* ContentLoader::LoadTexture(ContentLoader* loader, String* str, u32 num1, void* pointer, int32_t arg5 @ r5, int64_t arg6 @ q0, bool arg7)` | This is different from on mobile, textures are not loaded the same way. |
...
| `0x0021b770` | `int32_t MenuBackground::Draw(int32_t arg1)` | *Verify. No call references, no variable reference. According to the mobile versions its apart of a vtable, the ram dump i used is missing this i guess. |
...
| `0x0021fd8c` | `BaseDrawable* XNASpriteBatch::CreateSpriteText()` |  |
...
| `0x0022096c` | `void* SpriteBatch::Begin(SpriteBatch::Global())_2(XNASpriteBatch* drawer, bool zoomEnable, int32_t arg3, SpriteInfo* arg4)` | Almost identical to `SpriteBatch::Begin(SpriteBatch::Global())` at `0x002209e8`, but seems to return a value and call `SpriteBatch::Begin` differently (`b` instead of `bl`) |
...
| `0x00246298` | `int32_t GameStateManager::draw(void* arg1)` | Does not match the mobile function. |
...
| `0x00297c84` | `int32_t UI::DrawInterface(void* arg1)` |  |
...
| `0x0045ba54` | `int32_t Sprite::SetTexture(int32_t* arg1, int32_t* arg2)` |  |
...
| `0x005a3cc8` | `ContentLoader* GetImageLoader()` | Returns `&imageLoader`, may also call `ClearImageLoader()`. |
